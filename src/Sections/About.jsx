...
export default function AboutSection() {
  return (
    <div
      className="relative text-white overflow-hidden min-h-screen flex items-center justify-center bg-cover bg-center bg-fixed px-8 sm:px-6 md:px-10"
      style={{ backgroundImage: `url(${Aboutbg})` }}
    >
      <div className="absolute inset-0 bg-cover opacity-10 pointer-events-none" />

      {/* Main Card */}
      <div className="relative border-2 border-white p-4 sm:p-6 md:p-8 lg:p-12 sm:m-10 max-w-4xl w-full shadow-lg">
